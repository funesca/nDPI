...
static void ndpi_tls2json(ndpi_serializer *serializer, struct ndpi_flow_struct *flow)
{
  if(flow->protos.tls_quic.ssl_version)
  {
    ...
    if(!unknown_tls_version)
    {
      ...
      ndpi_serialize_string_string(serializer, "ja4_raw", flow->protos.tls_quic.ja4_client_raw);
      ndpi_serialize_string_string(serializer, "ja4_raw_uns", flow->protos.tls_quic.ja4_client_raw_unsorted);
